...
class ComparisonConfig:
    ...
    processed_root: Path = Path(r"C:\SWOT_universal_PIXC_quantile_filter\data\pipeline_2024\chile_reaches_with_valid_discharge_run\processed")
    experiment_root: Path = Path(r"C:\SWOT_universal_PIXC_quantile_filter\data\pipeline_2024\tau_range_update_experiment")
    experiment_results_csv: Path = Path(r"C:\SWOT_universal_PIXC_quantile_filter\data\pipeline_2024\tau_range_update_experiment\combined_results.csv")
    output_root: Path = Path(r"C:\SWOT_universal_PIXC_quantile_filter\data\pipeline_2024\riversp_comparison_updated_filter")

...
class TauRangeConfig:
    ...
    processed_root: Path = Path(
        r"C:\SWOT_universal_PIXC_quantile_filter\data\pipeline_2024\chile_reaches_with_valid_discharge_run\processed"
    )
    output_root: Path = Path(
        r"C:\SWOT_universal_PIXC_quantile_filter\data\pipeline_2024\tau_range_update_experiment"
    )
    reaches: tuple[str, ...] = ()
    year: int = 2024
